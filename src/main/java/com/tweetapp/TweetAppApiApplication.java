...
public class TweetAppApiApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Tweet APP Api",
				...
				"1.0", "Free to use", new springfox.documentation.service.Contact("Vedant S", "https://github.com",
						"vedantsugandhi95@gmail.com"),
				"VS license", "https://github.com", Collections.emptyList());
	}
